...
setLinkSelected(link)
    ...
    return (
        <div>
            {/* Header Section */}
            <div className=' flex justify-between py-3 pt-[19px] pr-[7px]  w-56 bg-theme-1'>
            ...
            <div className={`h-[89vh] ${isExpanded ? 'w-56' : 'w-16 '} bg-theme-1  text-white flex flex-col justify-between transition-all duration-300 `}>
                <div>
                    ...
                    <div className=' pt-[12px]  pl-[9px] pr-5  cursor-pointer'>
                        {isExpanded ? (
                            <>
                                ...
                                <h1 className='text-gray-500 pt-9 pl-[15px] text-md'>Recrutement</h1>
                                ...
                                <h1 className='text-gray-500 pl-[15px] pt-6 text-md'>Organisation</h1>
                ...
                <div className='  cursor-pointer  '>
                 { isExpanded ?(
                    <div className=' pl-1'>
                         <Link label="Besoin d'aide" size={15} link={"/help"}   selected={linkSelected==="/help"}  onclick={handleClick}/>
                        <p className='text-sm font-thin text-gray-500 px-[12px] text-nowrap'>Ouvrez votre centre d'aide</p>
                    </div>
                 ): <div className=' '>
                     <Link label="" size={15} link={"/help"} Icon={CircleHelp}  selected={linkSelected==="/help"}  onclick={handleClick}/>
                 </div>
                 }
